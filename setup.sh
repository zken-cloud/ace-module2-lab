...
# 5. Create private repository on GitHub and push the code
echo ""
echo "[5/5] Creating private repository 'ace-module2-lab' on GitHub..."
...
if gh repo view "$USERNAME/ace-module2-lab" >/dev/null 2>&1; then
  ...
  gh repo create ace-module2-lab --private --source=. --remote=origin --push
fi
